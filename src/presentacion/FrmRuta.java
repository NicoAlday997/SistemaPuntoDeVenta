...
public class FrmRuta extends javax.swing.JInternalFrame {
    ...
    private void listar(String texto, boolean paginar)
    {
        ...
        if(paginar==true){
            //tablaListado.setModel(this.CONTROL.listarTipo(texto, this.totalPorPagina,this.numPagina,"Ruta"));
            tablaListado.setModel(this.CONTROL.listar(texto, this.totalPorPagina,this.numPagina));


        }else{
             //tablaListado.setModel(this.CONTROL.listarTipo(texto, this.totalPorPagina,1,"Ruta"));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if(txtCobertura.getText().length()==0 || txtCobertura.getText().length()>70)
        {
            JOptionPane.showMessageDialog(this, "Debes ingresar una cobertura y no debe ser mayor a 70 caracteres, es obligatorio.", "Sistema", JOptionPane.WARNING_MESSAGE);
